...
#                    read('sparty.py')).group(1)
VERSION = read('VERSION').strip()
DESCRIPTION = 'Sharepoint pentest tool'
KEYWORDS = 'pentest sharepoint'
AUTHOR = 'Borja Ruiz'
AUTHOR_EMAIL = 'borja.ruiz@pentest.co.uk'
URL = 'https://www.github.com/borjiviri/sparty'
